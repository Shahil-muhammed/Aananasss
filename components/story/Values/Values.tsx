    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `
              linear-gradient(to right, rgba(247, 243, 232, 0.15) 1px, transparent 1px),
              linear-gradient(to bottom, rgba(247, 243, 232, 0.15) 1px, transparent 1px)
            `,
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6 md:px-12 lg:px-16">
          {/* Section Label (No special characters) */}
